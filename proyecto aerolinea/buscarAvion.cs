...
{
    public partial class buscarAvion : Form
    {
        public buscarAvion()
        {
            InitializeComponent();
        ...
        private void buscarPasajero_Load(object sender, EventArgs e)
        {
            void cargar()
            {
                ...
                string query = "Select avi_id as 'ID', avi_tipo as 'Tipo de Avión', pil_id as 'Id del piloto' from avion;";
        ...
        public _avion avionSeleccionado { get; set; }
